...
function myFunction3(){
  ...
  if (document.documentElement.scrollTop > 150 && document.documentElement.scrollTop <2405) {
    info.style.transition="0.4s";
    info.classList.add("sticky2");
    // info.style.padding= "35px";
  } else if(document.documentElement.scrollTop >2405 || document.documentElement.scrollTop
<=100    ){
    info.style.transition="0.4s";
